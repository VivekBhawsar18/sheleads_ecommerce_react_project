...
import { getFeatureProductById } from "../../services/ProductDataService";
...
const DetailsPage = (props) => {
  ...
  const getProductById = async () => {
    try {
      const data = await getFeatureProductById(prodId);
      setProdData(data);
        ...
        <div className="container detailsContainer pt-3 pb-3">
          <div className="row">
            ...
            <div className="col-md-7 productInfo">
              <h1>{prodData?.productName || "a"}</h1>
              <div className="d-flex align-items-center mb-4 mt-3">
                <Rating
                  name="half-rating-read"
                  value={parseFloat(prodData?.flatRate || "2")}
                  precision={0.5}
                  readOnly
                />
